...
def main() -> None: 
    ...
    while idx == 0: 
        ...
        if adoption == "Yes": 
            ...
            pet: str = input("Choose a pet by typing 1, 2, or 3: ")
            if pet == "1":
                cat_game() 
                possible_points += 3
            if pet == "2": 
        ...
        if points < 0: 
            points = 0
        print(f"{player}, You have earned {points} points.")
